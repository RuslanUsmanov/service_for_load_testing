...
# Задание:
    ...
    2. Выполнить нагрузочное тестирование эндпоинтов<sup>1</sup> сервиса. Список можно посмотреть в Swagger-документации, по ссылке [http://just-sol.duckdns.org:8000/api/docs](http://just-sol.duckdns.org:8000/api/docs)
